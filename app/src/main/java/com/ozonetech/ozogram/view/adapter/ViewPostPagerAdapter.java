...
public class ViewPostPagerAdapter extends PagerAdapter {
    ...
    public ViewPostPagerAdapter(Context context, ArrayList<PostGalleryPath> postGalleryPath, PostViewUnFollowUserListAdapter postRecycleViewAdapter, ViewPostActivity activity) {
