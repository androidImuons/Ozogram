...
OzogramHomeActivity activity;
    ...
    public UserPostPagerAdapter(Context context, ArrayList<PostGalleryPath> postGalleryPath, UnFollowUserListAdapter postRecycleViewAdapter, OzogramHomeActivity activity) {
