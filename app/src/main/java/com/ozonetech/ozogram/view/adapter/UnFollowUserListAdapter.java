...
public class UnFollowUserListAdapter extends PagerAdapter {
    ...
    OzogramHomeActivity ozogramHomeActivity;

    public UnFollowUserListAdapter(Context applicationContext, List<UnfollowUserRecordDataModel> unFollowUserList, OzogramHomeActivity ozogramHomeActivity) {
    ...
    private void setPagerAdapter(ViewModel viewModel, UnfollowUserRecordDataModel obj, int position) {
        ...
        if (postArray.size() > 0) {
            ...
            UserPostPagerAdapter postPagerAdapter = new UserPostPagerAdapter(context, postArray,
                    UnFollowUserListAdapter.this, ozogramHomeActivity);
